/**
	...
	* API code for job PnlWzemPrsRec (declarations)
...
namespace PnlWzemPrsRec {
	...
	public:
		StatShr(const Sbecore::uint ixWzemVExpstate = VecWzemVExpstate::REGD, const std::string& scrJrefDetail = "", const std::string& scrJrefADetail = "", const bool ButRegularizeActive = true);
