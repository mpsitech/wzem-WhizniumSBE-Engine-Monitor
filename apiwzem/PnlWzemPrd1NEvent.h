/**
	...
	* API code for job PnlWzemPrd1NEvent (declarations)
...
namespace PnlWzemPrd1NEvent {
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWzemPrd1NEvent::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWzemPrd1NEvent::StatApp statappqry;
