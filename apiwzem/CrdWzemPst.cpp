/**
	* \file CrdWzemPst.cpp
	* API code for job CrdWzemPst (implementation)
...
bool CrdWzemPst::ContInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfWzemPst");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "ContitemInfWzemPst";
...
bool CrdWzemPst::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppWzemPst");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppWzemPst";
...
set<uint> CrdWzemPst::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> CrdWzemPst::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool CrdWzemPst::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrWzemPst");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrWzemPst";
...
bool CrdWzemPst::Tag::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagWzemPst");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemWzemPst";
...
CrdWzemPst::DpchAppDo::DpchAppDo(
			...
			DpchAppWzem(VecWzemVDpch::DPCHAPPWZEMPSTDO, scrJref)
		{
...
void CrdWzemPst::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWzemPstDo");
...
CrdWzemPst::DpchEngData::DpchEngData() :
			DpchEngWzem(VecWzemVDpch::DPCHENGWZEMPSTDATA)
		{
...
void CrdWzemPst::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngWzemPstData");
	else
		basefound = checkXPath(docctx, basexpath);
