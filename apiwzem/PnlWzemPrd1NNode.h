/**
	...
	* API code for job PnlWzemPrd1NNode (declarations)
...
namespace PnlWzemPrd1NNode {
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWzemPrd1NNode::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWzemPrd1NNode::StatApp statappqry;
