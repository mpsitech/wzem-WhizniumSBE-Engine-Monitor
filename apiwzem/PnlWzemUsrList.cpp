/**
	...
	* API code for job PnlWzemUsrList (implementation)
...
bool PnlWzemUsrList::ContInf::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfWzemUsrList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "ContitemInfWzemUsrList";
...
bool PnlWzemUsrList::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrWzemUsrList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrWzemUsrList";
...
PnlWzemUsrList::Tag::Tag(
	...
	mask = {CPT, TRS, TXTSHOWING1, TXTSHOWING2, TCOGRP, TCOOWN, TCOPRS, TCOSRF, TCOUSG, TCOSTE, TCOLCL, TCOULV};
};

bool PnlWzemUsrList::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagWzemUsrList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemWzemUsrList";
...
PnlWzemUsrList::DpchAppData::DpchAppData(
			...
			DpchAppWzem(VecWzemVDpch::DPCHAPPWZEMUSRLISTDATA, scrJref)
		{
...
void PnlWzemUsrList::DpchAppData::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWzemUsrListData");
...
PnlWzemUsrList::DpchAppDo::DpchAppDo(
			...
			DpchAppWzem(VecWzemVDpch::DPCHAPPWZEMUSRLISTDO, scrJref)
		{
...
void PnlWzemUsrList::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWzemUsrListDo");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wzem");
		if (has(SCRJREF)) writeString(wr, "scrJref", scrJref);
...
PnlWzemUsrList::DpchEngData::DpchEngData() :
			DpchEngWzem(VecWzemVDpch::DPCHENGWZEMUSRLISTDATA)
		{
...
void PnlWzemUsrList::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngWzemUsrListData");
	else
		basefound = checkXPath(docctx, basexpath);
	...
	if (basefound) {
		...
		tag = Tag();
		rst.clear();
		statappqry = QryWzemUsrList::StatApp();
		statshrqry = QryWzemUsrList::StatShr();
