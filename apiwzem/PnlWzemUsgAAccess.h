...
namespace PnlWzemUsgAAccess {
	...
	public:
		...
		static const Sbecore::uint TCOFEG = 5;
		static const Sbecore::uint TCOFEA = 6;
		static const Sbecore::uint TCOACC = 7;

	public:
		Tag(const std::string& Cpt = "", const std::string& Trs = "", const std::string& TxtShowing1 = "", const std::string& TxtShowing2 = "", const std::string& TcoFeg = "", const std::string& TcoFea = "", const std::string& TcoAcc = "");
