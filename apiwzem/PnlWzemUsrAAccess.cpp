/**
	...
	* API code for job PnlWzemUsrAAccess (implementation)
...
bool PnlWzemUsrAAccess::ContInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfWzemUsrAAccess");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "ContitemInfWzemUsrAAccess";
...
PnlWzemUsrAAccess::StatApp::StatApp(
...
bool PnlWzemUsrAAccess::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppWzemUsrAAccess");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppWzemUsrAAccess";
...
set<uint> PnlWzemUsrAAccess::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> PnlWzemUsrAAccess::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool PnlWzemUsrAAccess::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrWzemUsrAAccess");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrWzemUsrAAccess";
...
bool PnlWzemUsrAAccess::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagWzemUsrAAccess");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemWzemUsrAAccess";
...
PnlWzemUsrAAccess::DpchAppData::DpchAppData(
			...
			DpchAppWzem(VecWzemVDpch::DPCHAPPWZEMUSRAACCESSDATA, scrJref)
		{
...
void PnlWzemUsrAAccess::DpchAppData::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWzemUsrAAccessData");
...
PnlWzemUsrAAccess::DpchAppDo::DpchAppDo(
			...
			DpchAppWzem(VecWzemVDpch::DPCHAPPWZEMUSRAACCESSDO, scrJref)
		{
...
void PnlWzemUsrAAccess::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWzemUsrAAccessDo");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wzem");
		if (has(SCRJREF)) writeString(wr, "scrJref", scrJref);
...
PnlWzemUsrAAccess::DpchEngData::DpchEngData() :
			DpchEngWzem(VecWzemVDpch::DPCHENGWZEMUSRAACCESSDATA)
		{
...
void PnlWzemUsrAAccess::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngWzemUsrAAccessData");
	else
		basefound = checkXPath(docctx, basexpath);
	...
	if (basefound) {
		...
		tag = Tag();
		rst.clear();
		statappqry = QryWzemUsrAAccess::StatApp();
		statshrqry = QryWzemUsrAAccess::StatShr();
