...
/******************************************************************************
 class QryWzemJobList::VecVOrd
 ******************************************************************************/

uint QryWzemJobList::VecVOrd::getIx(
			const string& sref
		) {
...
QryWzemJobList::StatApp::StatApp(
			const uint firstcol
...
bool QryWzemJobList::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryWzemJobList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryWzemJobList";
...
set<uint> QryWzemJobList::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryWzemJobList::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryWzemJobList::StatShr
 ******************************************************************************/

QryWzemJobList::StatShr::StatShr(
			const uint ntot
...
bool QryWzemJobList::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryWzemJobList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryWzemJobList";
...
set<uint> QryWzemJobList::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryWzemJobList::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryWzemJobList::StgIac
 ******************************************************************************/

QryWzemJobList::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) :
...
bool QryWzemJobList::StgIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryWzemJobList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryWzemJobList";
...
void QryWzemJobList::StgIac::writeXML(
	...
	else itemtag = "StgitemIacQryWzemJobList";
...
set<uint> QryWzemJobList::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryWzemJobList::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
