...
namespace PnlWzemEvtList {
	...
	public:
		...
		static const Sbecore::uint TCOTYP = 5;
		static const Sbecore::uint TCOPRD = 6;
		static const Sbecore::uint TCOSTA = 7;
		static const Sbecore::uint TCOCMD = 8;
		static const Sbecore::uint TCOFEG = 9;
		static const Sbecore::uint TCOMTD = 10;
		static const Sbecore::uint TCOXSR = 11;

	public:
		Tag(const std::string& Cpt = "", const std::string& Trs = "", const std::string& TxtShowing1 = "", const std::string& TxtShowing2 = "", const std::string& TcoTyp = "", const std::string& TcoPrd = "", const std::string& TcoSta = "", const std::string& TcoCmd = "", const std::string& TcoFeg = "", const std::string& TcoMtd = "", const std::string& TcoXsr = "");
