...
namespace PnlWzemPstList {
	...
	public:
		...
		static const Sbecore::uint TCOPST = 8;
		static const Sbecore::uint TCOSTA = 9;
		static const Sbecore::uint TCOSTO = 10;

	public:
		Tag(const std::string& Cpt = "", const std::string& TxtRecord1 = "", const std::string& TxtRecord2 = "", const std::string& Trs = "", const std::string& TxtShowing1 = "", const std::string& TxtShowing2 = "", const std::string& TcoJob = "", const std::string& TcoPst = "", const std::string& TcoSta = "", const std::string& TcoSto = "");
