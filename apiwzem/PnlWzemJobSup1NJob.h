/**
	...
	* API code for job PnlWzemJobSup1NJob (declarations)
...
namespace PnlWzemJobSup1NJob {
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWzemJobSup1NJob::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWzemJobSup1NJob::StatApp statappqry;
