/**
	...
	* API code for job PnlWzemJob1NClstn (implementation)
...
bool PnlWzemJob1NClstn::ContInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfWzemJob1NClstn");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "ContitemInfWzemJob1NClstn";
...
PnlWzemJob1NClstn::StatApp::StatApp(
...
bool PnlWzemJob1NClstn::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppWzemJob1NClstn");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppWzemJob1NClstn";
...
set<uint> PnlWzemJob1NClstn::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> PnlWzemJob1NClstn::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool PnlWzemJob1NClstn::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrWzemJob1NClstn");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrWzemJob1NClstn";
...
bool PnlWzemJob1NClstn::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagWzemJob1NClstn");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemWzemJob1NClstn";
...
PnlWzemJob1NClstn::DpchAppData::DpchAppData(
			...
			DpchAppWzem(VecWzemVDpch::DPCHAPPWZEMJOB1NCLSTNDATA, scrJref)
		{
...
void PnlWzemJob1NClstn::DpchAppData::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWzemJob1NClstnData");
...
PnlWzemJob1NClstn::DpchAppDo::DpchAppDo(
			...
			DpchAppWzem(VecWzemVDpch::DPCHAPPWZEMJOB1NCLSTNDO, scrJref)
		{
...
void PnlWzemJob1NClstn::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWzemJob1NClstnDo");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wzem");
		if (has(SCRJREF)) writeString(wr, "scrJref", scrJref);
...
PnlWzemJob1NClstn::DpchEngData::DpchEngData() :
			DpchEngWzem(VecWzemVDpch::DPCHENGWZEMJOB1NCLSTNDATA)
		{
...
void PnlWzemJob1NClstn::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngWzemJob1NClstnData");
	else
		basefound = checkXPath(docctx, basexpath);
	...
	if (basefound) {
		...
		tag = Tag();
		rst.clear();
		statappqry = QryWzemJob1NClstn::StatApp();
		statshrqry = QryWzemJob1NClstn::StatShr();
