/**
	...
	* API code for job QryWzemUsrMNUsergroup (implementation)
...
QryWzemUsrMNUsergroup::StatApp::StatApp(
			const uint firstcol
...
bool QryWzemUsrMNUsergroup::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryWzemUsrMNUsergroup");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryWzemUsrMNUsergroup";
...
set<uint> QryWzemUsrMNUsergroup::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryWzemUsrMNUsergroup::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool QryWzemUsrMNUsergroup::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryWzemUsrMNUsergroup");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryWzemUsrMNUsergroup";
