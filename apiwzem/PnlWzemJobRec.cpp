...
PnlWzemJobRec::StatApp::StatApp(
	...
	mask = {INITDONEDETAIL, INITDONE1NCALL, INITDONE1NOP, INITDONE1NCLSTN, INITDONE1NPRESET, INITDONESUP1NJOB};
};
...
set<uint> PnlWzemJobRec::StatApp::diff(
	...
	diffitems = {INITDONEDETAIL, INITDONE1NCALL, INITDONE1NOP, INITDONE1NCLSTN, INITDONE1NPRESET, INITDONESUP1NJOB};
	for (auto it = commitems.begin(); it != commitems.end(); it++) diffitems.erase(*it);
...
PnlWzemJobRec::StatShr::StatShr(
	...
	mask = {IXWZEMVEXPSTATE, SCRJREFDETAIL, SCRJREF1NCALL, SCRJREF1NOP, SCRJREF1NCLSTN, SCRJREF1NPRESET, SCRJREFSUP1NJOB, BUTREGULARIZEACTIVE};
};
...
set<uint> PnlWzemJobRec::StatShr::diff(
	...
	diffitems = {IXWZEMVEXPSTATE, SCRJREFDETAIL, SCRJREF1NCALL, SCRJREF1NOP, SCRJREF1NCLSTN, SCRJREF1NPRESET, SCRJREFSUP1NJOB, BUTREGULARIZEACTIVE};
	for (auto it = commitems.begin(); it != commitems.end(); it++) diffitems.erase(*it);
