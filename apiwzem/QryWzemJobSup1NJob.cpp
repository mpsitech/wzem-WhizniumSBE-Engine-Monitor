/**
	...
	* API code for job QryWzemJobSup1NJob (implementation)
...
QryWzemJobSup1NJob::StatApp::StatApp(
			const uint firstcol
...
bool QryWzemJobSup1NJob::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryWzemJobSup1NJob");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryWzemJobSup1NJob";
...
set<uint> QryWzemJobSup1NJob::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryWzemJobSup1NJob::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool QryWzemJobSup1NJob::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryWzemJobSup1NJob");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryWzemJobSup1NJob";
