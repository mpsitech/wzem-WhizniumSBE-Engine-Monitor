/**
	...
	* API code for job PnlWzemJob1NClstn (declarations)
...
namespace PnlWzemJob1NClstn {
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWzemJob1NClstn::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWzemJob1NClstn::StatApp statappqry;
