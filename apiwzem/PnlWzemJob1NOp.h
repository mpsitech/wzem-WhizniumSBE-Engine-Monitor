/**
	...
	* API code for job PnlWzemJob1NOp (declarations)
...
namespace PnlWzemJob1NOp {
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWzemJob1NOp::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWzemJob1NOp::StatApp statappqry;
