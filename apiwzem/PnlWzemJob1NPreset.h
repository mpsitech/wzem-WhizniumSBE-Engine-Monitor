/**
	...
	* API code for job PnlWzemJob1NPreset (declarations)
...
namespace PnlWzemJob1NPreset {
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWzemJob1NPreset::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWzemJob1NPreset::StatApp statappqry;
