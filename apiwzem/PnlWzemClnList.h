...
namespace PnlWzemClnList {
	...
	public:
		...
		static const Sbecore::uint TCOCAL = 6;
		static const Sbecore::uint TCOSGE = 7;
		static const Sbecore::uint TCOSTA = 8;
		static const Sbecore::uint TCOSTO = 9;

	public:
		Tag(const std::string& Cpt = "", const std::string& Trs = "", const std::string& TxtShowing1 = "", const std::string& TxtShowing2 = "", const std::string& TcoJob = "", const std::string& TcoCal = "", const std::string& TcoSge = "", const std::string& TcoSta = "", const std::string& TcoSto = "");
