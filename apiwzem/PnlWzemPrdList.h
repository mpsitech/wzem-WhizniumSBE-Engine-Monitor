...
namespace PnlWzemPrdList {
	...
	public:
		...
		static const Sbecore::uint TCOVER = 7;
		static const Sbecore::uint TCOSTA = 8;
		static const Sbecore::uint TCOSTO = 9;

	public:
		Tag(const std::string& Cpt = "", const std::string& Trs = "", const std::string& TxtShowing1 = "", const std::string& TxtShowing2 = "", const std::string& TcoGrp = "", const std::string& TcoOwn = "", const std::string& TcoVer = "", const std::string& TcoSta = "", const std::string& TcoSto = "");
