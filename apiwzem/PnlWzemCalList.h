...
namespace PnlWzemCalList {
	...
	public:
		Tag(const std::string& Cpt = "", const std::string& Trs = "", const std::string& TxtShowing1 = "", const std::string& TxtShowing2 = "", const std::string& TcoJob = "", const std::string& TcoCal = "", const std::string& TcoSta = "", const std::string& TcoSto = "");
