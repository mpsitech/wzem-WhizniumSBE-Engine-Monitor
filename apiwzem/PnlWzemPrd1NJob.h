/**
	...
	* API code for job PnlWzemPrd1NJob (declarations)
...
namespace PnlWzemPrd1NJob {
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWzemPrd1NJob::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWzemPrd1NJob::StatApp statappqry;
