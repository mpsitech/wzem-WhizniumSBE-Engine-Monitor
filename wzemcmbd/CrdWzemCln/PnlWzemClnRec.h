/**
	...
	* job handler for job PnlWzemClnRec (declarations)
...
/**
	* PnlWzemClnRec
	*/
class PnlWzemClnRec : public JobWzem {
...
public:
	PnlWzemClnRec(XchgWzem* xchg, DbsWzem* dbswzem, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWzemVLocale);
	~PnlWzemClnRec();
