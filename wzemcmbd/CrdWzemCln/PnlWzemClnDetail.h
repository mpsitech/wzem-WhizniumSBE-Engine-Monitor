...
public:
	...
	public:
		static void writeJSON(Json::Value& sup, std::string difftag = "", const Sbecore::uint ixWzemVExpstate = VecWzemVExpstate::MIND, const bool LstAmsAlt = true, const Sbecore::uint LstAmsNumFirstdisp = 1);
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Sbecore::Feed* feedFLstAms = NULL, Sbecore::Feed* feedFPupJat = NULL, Sbecore::Feed* feedFPupJms = NULL, Sbecore::Feed* feedFPupTrg = NULL, StatShr* statshr = NULL, const std::set<Sbecore::uint>& mask = {NONE});

	public:
		ContIac contiac;
		ContInf continf;
		Sbecore::Feed feedFLstAms;
		Sbecore::Feed feedFPupJat;
		Sbecore::Feed feedFPupJms;
