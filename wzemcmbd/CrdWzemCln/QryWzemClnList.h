/**
	...
	* job handler for job QryWzemClnList (declarations)
...
#define QRYWZEMCLNLIST_H

// IP include.spec --- INSERT

// IP include.cust --- INSERT

#define VecVQryWzemClnListOrd QryWzemClnList::VecVOrd

#define StatAppQryWzemClnList QryWzemClnList::StatApp
#define StatShrQryWzemClnList QryWzemClnList::StatShr
#define StgIacQryWzemClnList QryWzemClnList::StgIac

/**
	* QryWzemClnList
	*/
class QryWzemClnList : public JobWzem {

public:
	/**
		* VecVOrd (full: VecVQryWzemClnListOrd)
		*/
	class VecVOrd {
	...
	/**
		* StatApp (full: StatAppQryWzemClnList)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrQryWzemClnList)
		*/
	...
	/**
		* StgIac (full: StgIacQryWzemClnList)
		*/
...
public:
	QryWzemClnList(XchgWzem* xchg, DbsWzem* dbswzem, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWzemVLocale);
	~QryWzemClnList();
...
public:
	...
	WzemQClnList* getRecByJnum(const Sbecore::uint jnum);
...
private:
	...
	bool handleCallWzemClnMod(DbsWzem* dbswzem, const Sbecore::ubigint jrefTrig);
