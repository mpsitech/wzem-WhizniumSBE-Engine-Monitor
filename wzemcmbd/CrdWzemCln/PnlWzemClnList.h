...
/**
	* PnlWzemClnList
	*/
class PnlWzemClnList : public JobWzem {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, Sbecore::Xmlio::Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWzemQClnList* rst = NULL, QryWzemClnList::StatShr* statshrqry = NULL, QryWzemClnList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWzemClnList(XchgWzem* xchg, DbsWzem* dbswzem, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWzemVLocale);
	~PnlWzemClnList();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWzem* dbswzem, QryWzemClnList::StgIac* _stgiacqry, DpchEngWzem** dpcheng);
