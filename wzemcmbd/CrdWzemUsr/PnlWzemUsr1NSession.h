...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWzemQUsr1NSession* rst = NULL, QryWzemUsr1NSession::StatShr* statshrqry = NULL, QryWzemUsr1NSession::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
