/**
	* \file PnlWzemUsrRec_blks.cpp
	* job handler for job PnlWzemUsrRec (implementation of blocks)
...
void PnlWzemUsrRec::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWzemUsrRec";
...
void PnlWzemUsrRec::ContInf::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	else itemtag = "ContitemInfWzemUsrRec";
...
void PnlWzemUsrRec::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
	...
	if (difftag.length() == 0) difftag = "StatAppWzemUsrRec";
...
void PnlWzemUsrRec::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const bool initdoneDetail
	...
	else itemtag = "StatitemAppWzemUsrRec";
...
PnlWzemUsrRec::StatShr::StatShr(
	...
	mask = {IXWZEMVEXPSTATE, JREFDETAIL, JREFAACCESS, JREF1NSESSION, JREFMNUSERGROUP, BUTREGULARIZEACTIVE};
};

void PnlWzemUsrRec::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWzemUsrRec";
...
void PnlWzemUsrRec::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrWzemUsrRec";
...
set<uint> PnlWzemUsrRec::StatShr::diff(
	...
	diffitems = {IXWZEMVEXPSTATE, JREFDETAIL, JREFAACCESS, JREF1NSESSION, JREFMNUSERGROUP, BUTREGULARIZEACTIVE};
	for (auto it = commitems.begin(); it != commitems.end(); it++) diffitems.erase(*it);
...
void PnlWzemUsrRec::Tag::writeJSON(
			const uint ixWzemVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWzemUsrRec";
...
void PnlWzemUsrRec::Tag::writeXML(
			const uint ixWzemVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWzemUsrRec";
...
PnlWzemUsrRec::DpchAppDo::DpchAppDo() :
			DpchAppWzem(VecWzemVDpch::DPCHAPPWZEMUSRRECDO)
		{
	ixVDo = 0;
};
...
void PnlWzemUsrRec::DpchAppDo::readJSON(
			Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	Json::Value& me = sup;
	if (addbasetag) me = sup["DpchAppWzemUsrRecDo"];
...
void PnlWzemUsrRec::DpchAppDo::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWzemUsrRecDo");
	else
...
PnlWzemUsrRec::DpchEngData::DpchEngData(
			...
			DpchEngWzem(VecWzemVDpch::DPCHENGWZEMUSRRECDATA, jref)
		{
...
void PnlWzemUsrRec::DpchEngData::merge(
			DpchEngWzem* dpcheng
		) {
...
void PnlWzemUsrRec::DpchEngData::writeJSON(
			const uint ixWzemVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWzemUsrRecData"] = Json::Value(Json::objectValue);
...
void PnlWzemUsrRec::DpchEngData::writeXML(
			const uint ixWzemVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWzemUsrRecData");
