...
/******************************************************************************
 class QryWzemUsrList::VecVOrd
 ******************************************************************************/

uint QryWzemUsrList::VecVOrd::getIx(
			const string& sref
		) {
...
void QryWzemUsrList::VecVOrd::fillFeed(
			Feed& feed
		) {
	feed.clear();
...
/******************************************************************************
 class QryWzemUsrList::StatApp
 ******************************************************************************/

void QryWzemUsrList::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint firstcol
	...
	if (difftag.length() == 0) difftag = "StatAppQryWzemUsrList";
...
void QryWzemUsrList::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint firstcol
	...
	else itemtag = "StatitemAppQryWzemUsrList";
...
/******************************************************************************
 class QryWzemUsrList::StatShr
 ******************************************************************************/

QryWzemUsrList::StatShr::StatShr(
			const uint ntot
...
void QryWzemUsrList::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrQryWzemUsrList";
...
void QryWzemUsrList::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrQryWzemUsrList";
...
set<uint> QryWzemUsrList::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryWzemUsrList::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryWzemUsrList::StgIac
 ******************************************************************************/

QryWzemUsrList::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) :
...
bool QryWzemUsrList::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacQryWzemUsrList"];}();
...
bool QryWzemUsrList::StgIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryWzemUsrList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryWzemUsrList";
...
void QryWzemUsrList::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StgIacQryWzemUsrList";
...
void QryWzemUsrList::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryWzemUsrList";
...
set<uint> QryWzemUsrList::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryWzemUsrList::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
