/**
	...
	* job handler for job PnlWzemUsrAAccess (declarations)
...
/**
	* PnlWzemUsrAAccess
	*/
class PnlWzemUsrAAccess : public JobWzem {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWzemQUsrAAccess* rst = NULL, QryWzemUsrAAccess::StatShr* statshrqry = NULL, QryWzemUsrAAccess::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWzemUsrAAccess(XchgWzem* xchg, DbsWzem* dbswzem, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWzemVLocale);
	~PnlWzemUsrAAccess();
...
public:
	...
	QryWzemUsrAAccess* qry;

	WzemAMUserAccess recUsrAacc;
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWzem* dbswzem, QryWzemUsrAAccess::StgIac* _stgiacqry, DpchEngWzem** dpcheng);
