...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWzemQJobSup1NJob* rst = NULL, QryWzemJobSup1NJob::StatShr* statshrqry = NULL, QryWzemJobSup1NJob::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
