...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWzemQJob1NPreset* rst = NULL, QryWzemJob1NPreset::StatShr* statshrqry = NULL, QryWzemJob1NPreset::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
