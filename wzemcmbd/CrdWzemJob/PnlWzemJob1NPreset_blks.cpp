/**
	* \file PnlWzemJob1NPreset_blks.cpp
	* job handler for job PnlWzemJob1NPreset (implementation of blocks)
...
void PnlWzemJob1NPreset::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWzemJob1NPreset";
...
void PnlWzemJob1NPreset::ContInf::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	else itemtag = "ContitemInfWzemJob1NPreset";
...
void PnlWzemJob1NPreset::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint ixWzemVExpstate
		) {
	if (difftag.length() == 0) difftag = "StatAppWzemJob1NPreset";
...
void PnlWzemJob1NPreset::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint ixWzemVExpstate
	...
	else itemtag = "StatitemAppWzemJob1NPreset";
...
void PnlWzemJob1NPreset::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWzemJob1NPreset";
...
void PnlWzemJob1NPreset::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrWzemJob1NPreset";
...
bool PnlWzemJob1NPreset::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacWzemJob1NPreset"];}();
...
void PnlWzemJob1NPreset::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
void PnlWzemJob1NPreset::Tag::writeJSON(
			const uint ixWzemVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWzemJob1NPreset";
...
void PnlWzemJob1NPreset::Tag::writeXML(
			const uint ixWzemVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWzemJob1NPreset";
...
PnlWzemJob1NPreset::DpchAppData::DpchAppData() :
			DpchAppWzem(VecWzemVDpch::DPCHAPPWZEMJOB1NPRESETDATA)
		{
};
...
void PnlWzemJob1NPreset::DpchAppData::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWzemJob1NPresetData"];}();
...
void PnlWzemJob1NPreset::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWzemJob1NPresetData");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWzemJob1NPreset::DpchAppDo::DpchAppDo() :
			DpchAppWzem(VecWzemVDpch::DPCHAPPWZEMJOB1NPRESETDO)
		{
	ixVDo = 0;
};
...
void PnlWzemJob1NPreset::DpchAppDo::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWzemJob1NPresetDo"];}();
...
void PnlWzemJob1NPreset::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWzemJob1NPresetDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWzemJob1NPreset::DpchEngData::DpchEngData(
			...
			DpchEngWzem(VecWzemVDpch::DPCHENGWZEMJOB1NPRESETDATA, jref)
		{
...
void PnlWzemJob1NPreset::DpchEngData::merge(
			DpchEngWzem* dpcheng
		) {
...
void PnlWzemJob1NPreset::DpchEngData::writeJSON(
			const uint ixWzemVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWzemJob1NPresetData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryWzemJob1NPreset::StatApp::writeJSON(me);
	if (has(STATSHRQRY)) statshrqry.writeJSON(me);
	if (has(STGIACQRY)) stgiacqry.writeJSON(me);
};

void PnlWzemJob1NPreset::DpchEngData::writeXML(
			const uint ixWzemVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWzemJob1NPresetData");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wzem");
		...
		if (has(STATAPPQRY)) QryWzemJob1NPreset::StatApp::writeXML(wr);
