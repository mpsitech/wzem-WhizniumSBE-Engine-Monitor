/**
	* \file PnlWzemJob1NOp.h
	* job handler for job PnlWzemJob1NOp (declarations)
...
#ifndef PNLWZEMJOB1NOP_H
#define PNLWZEMJOB1NOP_H
...
#define VecVWzemJob1NOpDo PnlWzemJob1NOp::VecVDo

#define ContInfWzemJob1NOp PnlWzemJob1NOp::ContInf
#define StatAppWzemJob1NOp PnlWzemJob1NOp::StatApp
#define StatShrWzemJob1NOp PnlWzemJob1NOp::StatShr
#define StgIacWzemJob1NOp PnlWzemJob1NOp::StgIac
#define TagWzemJob1NOp PnlWzemJob1NOp::Tag

#define DpchAppWzemJob1NOpData PnlWzemJob1NOp::DpchAppData
#define DpchAppWzemJob1NOpDo PnlWzemJob1NOp::DpchAppDo
#define DpchEngWzemJob1NOpData PnlWzemJob1NOp::DpchEngData

/**
	* PnlWzemJob1NOp
	*/
class PnlWzemJob1NOp : public JobWzem {

public:
	/**
		* VecVDo (full: VecVWzemJob1NOpDo)
		*/
	class VecVDo {
	...
	/**
	  * ContInf (full: ContInfWzemJob1NOp)
	  */
	...
	/**
		* StatApp (full: StatAppWzemJob1NOp)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrWzemJob1NOp)
		*/
	...
	/**
		* DpchAppData (full: DpchAppWzemJob1NOpData)
		*/
	...
	/**
		* DpchAppDo (full: DpchAppWzemJob1NOpDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngWzemJob1NOpData)
		*/
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWzemQJob1NOp* rst = NULL, QryWzemJob1NOp::StatShr* statshrqry = NULL, QryWzemJob1NOp::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWzemJob1NOp(XchgWzem* xchg, DbsWzem* dbswzem, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWzemVLocale);
	~PnlWzemJob1NOp();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWzem* dbswzem, QryWzemJob1NOp::StgIac* _stgiacqry, DpchEngWzem** dpcheng);
