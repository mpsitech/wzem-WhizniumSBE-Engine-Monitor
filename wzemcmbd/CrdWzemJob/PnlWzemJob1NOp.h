...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWzemQJob1NOp* rst = NULL, QryWzemJob1NOp::StatShr* statshrqry = NULL, QryWzemJob1NOp::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
