...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWzemQJob1NCall* rst = NULL, QryWzemJob1NCall::StatShr* statshrqry = NULL, QryWzemJob1NCall::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
