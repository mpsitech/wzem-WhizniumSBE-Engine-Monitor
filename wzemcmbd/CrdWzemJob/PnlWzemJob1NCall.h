/**
	...
	* job handler for job PnlWzemJob1NCall (declarations)
...
/**
	* PnlWzemJob1NCall
	*/
class PnlWzemJob1NCall : public JobWzem {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWzemQJob1NCall* rst = NULL, QryWzemJob1NCall::StatShr* statshrqry = NULL, QryWzemJob1NCall::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWzemJob1NCall(XchgWzem* xchg, DbsWzem* dbswzem, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWzemVLocale);
	~PnlWzemJob1NCall();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWzem* dbswzem, QryWzemJob1NCall::StgIac* _stgiacqry, DpchEngWzem** dpcheng);
