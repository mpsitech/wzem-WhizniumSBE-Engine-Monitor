/**
	* \file CrdWzemJob.h
	* job handler for job CrdWzemJob (declarations)
...
#define ContInfWzemJob CrdWzemJob::ContInf
#define StatAppWzemJob CrdWzemJob::StatApp
#define StatShrWzemJob CrdWzemJob::StatShr
#define TagWzemJob CrdWzemJob::Tag

#define DpchAppWzemJobDo CrdWzemJob::DpchAppDo
#define DpchEngWzemJobData CrdWzemJob::DpchEngData

/**
	* CrdWzemJob
	*/
class CrdWzemJob : public JobWzem {

public:
	/**
		* VecVDo (full: VecVWzemJobDo)
		*/
	class VecVDo {
	...
	/**
		* DpchAppDo (full: DpchAppWzemJobDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngWzemJobData)
		*/
...
public:
	CrdWzemJob(XchgWzem* xchg, DbsWzem* dbswzem, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWzemVLocale, const Sbecore::ubigint ref = 0, const Sbecore::uint ixWzemVPreset = VecWzemVPreset::VOID, const Sbecore::ubigint preUref = 0);
	~CrdWzemJob();
