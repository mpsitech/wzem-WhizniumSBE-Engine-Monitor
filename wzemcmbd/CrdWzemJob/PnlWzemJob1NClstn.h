...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWzemQJob1NClstn* rst = NULL, QryWzemJob1NClstn::StatShr* statshrqry = NULL, QryWzemJob1NClstn::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
