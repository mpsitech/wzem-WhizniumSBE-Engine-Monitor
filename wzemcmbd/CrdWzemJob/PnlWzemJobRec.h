...
public:
	...
	public:
		static void writeXML(xmlTextWriter* wr, std::string difftag = "", bool shorttags = true, const bool initdoneDetail = false, const bool initdone1NCall = false, const bool initdone1NOp = false, const bool initdone1NClstn = false, const bool initdone1NPreset = false, const bool initdoneSup1NJob = false);
	};
	...
	public:
		...
		static const Sbecore::uint JREF1NCALL = 3;
		static const Sbecore::uint JREF1NOP = 4;
		static const Sbecore::uint JREF1NCLSTN = 5;
	...
	public:
		StatShr(const Sbecore::uint ixWzemVExpstate = VecWzemVExpstate::REGD, const Sbecore::ubigint jrefDetail = 0, const Sbecore::ubigint jref1NCall = 0, const Sbecore::ubigint jref1NOp = 0, const Sbecore::ubigint jref1NClstn = 0, const Sbecore::ubigint jref1NPreset = 0, const Sbecore::ubigint jrefSup1NJob = 0, const bool ButRegularizeActive = true);
