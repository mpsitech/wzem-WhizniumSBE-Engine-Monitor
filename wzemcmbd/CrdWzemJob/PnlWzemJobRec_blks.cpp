...
PnlWzemJobRec::StatShr::StatShr(
	...
	mask = {IXWZEMVEXPSTATE, JREFDETAIL, JREF1NCALL, JREF1NOP, JREF1NCLSTN, JREF1NPRESET, JREFSUP1NJOB, BUTREGULARIZEACTIVE};
};
...
set<uint> PnlWzemJobRec::StatShr::diff(
	...
	diffitems = {IXWZEMVEXPSTATE, JREFDETAIL, JREF1NCALL, JREF1NOP, JREF1NCLSTN, JREF1NPRESET, JREFSUP1NJOB, BUTREGULARIZEACTIVE};
	for (auto it = commitems.begin(); it != commitems.end(); it++) diffitems.erase(*it);
