/**
	* \file PnlWzemUsgDetail_blks.cpp
	* job handler for job PnlWzemUsgDetail (implementation of blocks)
...
bool PnlWzemUsgDetail::ContIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["ContIacWzemUsgDetail"];}();
...
void PnlWzemUsgDetail::ContIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
void PnlWzemUsgDetail::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWzemUsgDetail";
...
void PnlWzemUsgDetail::ContInf::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Ci";
	else itemtag = "ContitemInfWzemUsgDetail";
...
void PnlWzemUsgDetail::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint ixWzemVExpstate
		) {
	if (difftag.length() == 0) difftag = "StatAppWzemUsgDetail";
...
void PnlWzemUsgDetail::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint ixWzemVExpstate
	...
	else itemtag = "StatitemAppWzemUsgDetail";
...
void PnlWzemUsgDetail::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWzemUsgDetail";
...
void PnlWzemUsgDetail::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrWzemUsgDetail";
...
void PnlWzemUsgDetail::Tag::writeJSON(
			const uint ixWzemVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWzemUsgDetail";
...
void PnlWzemUsgDetail::Tag::writeXML(
			const uint ixWzemVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWzemUsgDetail";
...
PnlWzemUsgDetail::DpchAppData::DpchAppData() :
			DpchAppWzem(VecWzemVDpch::DPCHAPPWZEMUSGDETAILDATA)
		{
};
...
void PnlWzemUsgDetail::DpchAppData::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWzemUsgDetailData"];}();
...
void PnlWzemUsgDetail::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWzemUsgDetailData");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWzemUsgDetail::DpchAppDo::DpchAppDo() :
			DpchAppWzem(VecWzemVDpch::DPCHAPPWZEMUSGDETAILDO)
		{
	ixVDo = 0;
};
...
void PnlWzemUsgDetail::DpchAppDo::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWzemUsgDetailDo"];}();
...
void PnlWzemUsgDetail::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWzemUsgDetailDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWzemUsgDetail::DpchEngData::DpchEngData(
			...
			DpchEngWzem(VecWzemVDpch::DPCHENGWZEMUSGDETAILDATA, jref)
		{
...
void PnlWzemUsgDetail::DpchEngData::merge(
			DpchEngWzem* dpcheng
		) {
...
void PnlWzemUsgDetail::DpchEngData::writeJSON(
			const uint ixWzemVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWzemUsgDetailData"] = Json::Value(Json::objectValue);
...
void PnlWzemUsgDetail::DpchEngData::writeXML(
			const uint ixWzemVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWzemUsgDetailData");
