...
void PnlWzemUsgAAccess::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWzemUsgAAccess";
...
void PnlWzemUsgAAccess::ContInf::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	else itemtag = "ContitemInfWzemUsgAAccess";
...
void PnlWzemUsgAAccess::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint ixWzemVExpstate
		) {
	if (difftag.length() == 0) difftag = "StatAppWzemUsgAAccess";
...
void PnlWzemUsgAAccess::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint ixWzemVExpstate
	...
	else itemtag = "StatitemAppWzemUsgAAccess";
...
void PnlWzemUsgAAccess::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWzemUsgAAccess";
...
void PnlWzemUsgAAccess::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrWzemUsgAAccess";
...
bool PnlWzemUsgAAccess::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacWzemUsgAAccess"];}();
...
void PnlWzemUsgAAccess::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
void PnlWzemUsgAAccess::Tag::writeJSON(
			const uint ixWzemVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWzemUsgAAccess";
...
void PnlWzemUsgAAccess::Tag::writeXML(
			const uint ixWzemVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWzemUsgAAccess";
...
PnlWzemUsgAAccess::DpchAppData::DpchAppData() :
			DpchAppWzem(VecWzemVDpch::DPCHAPPWZEMUSGAACCESSDATA)
		{
};
...
void PnlWzemUsgAAccess::DpchAppData::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWzemUsgAAccessData"];}();
...
void PnlWzemUsgAAccess::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWzemUsgAAccessData");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWzemUsgAAccess::DpchAppDo::DpchAppDo() :
			DpchAppWzem(VecWzemVDpch::DPCHAPPWZEMUSGAACCESSDO)
		{
	ixVDo = 0;
};
...
void PnlWzemUsgAAccess::DpchAppDo::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWzemUsgAAccessDo"];}();
...
void PnlWzemUsgAAccess::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWzemUsgAAccessDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWzemUsgAAccess::DpchEngData::DpchEngData(
			...
			DpchEngWzem(VecWzemVDpch::DPCHENGWZEMUSGAACCESSDATA, jref)
		{
...
void PnlWzemUsgAAccess::DpchEngData::merge(
			DpchEngWzem* dpcheng
		) {
...
void PnlWzemUsgAAccess::DpchEngData::writeJSON(
			const uint ixWzemVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWzemUsgAAccessData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryWzemUsgAAccess::StatApp::writeJSON(me);
	if (has(STATSHRQRY)) statshrqry.writeJSON(me);
	if (has(STGIACQRY)) stgiacqry.writeJSON(me);
};

void PnlWzemUsgAAccess::DpchEngData::writeXML(
			const uint ixWzemVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWzemUsgAAccessData");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wzem");
		...
		if (has(STATAPPQRY)) QryWzemUsgAAccess::StatApp::writeXML(wr);
