/**
	...
	* job handler for job PnlWzemUsgAAccess (declarations)
...
/**
	* PnlWzemUsgAAccess
	*/
class PnlWzemUsgAAccess : public JobWzem {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWzemQUsgAAccess* rst = NULL, QryWzemUsgAAccess::StatShr* statshrqry = NULL, QryWzemUsgAAccess::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWzemUsgAAccess(XchgWzem* xchg, DbsWzem* dbswzem, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWzemVLocale);
	~PnlWzemUsgAAccess();
...
public:
	...
	QryWzemUsgAAccess* qry;

	WzemAMUsergroupAccess recUsgAacc;
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWzem* dbswzem, QryWzemUsgAAccess::StgIac* _stgiacqry, DpchEngWzem** dpcheng);
