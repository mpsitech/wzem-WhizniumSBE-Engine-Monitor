/**
	* \file PnlWzemUsgDetail.h
	* job handler for job PnlWzemUsgDetail (declarations)
...
#ifndef PNLWZEMUSGDETAIL_H
#define PNLWZEMUSGDETAIL_H

// IP include.spec --- INSERT

// IP include.cust --- INSERT

#define VecVWzemUsgDetailDo PnlWzemUsgDetail::VecVDo

#define ContIacWzemUsgDetail PnlWzemUsgDetail::ContIac
#define ContInfWzemUsgDetail PnlWzemUsgDetail::ContInf
#define StatAppWzemUsgDetail PnlWzemUsgDetail::StatApp
#define StatShrWzemUsgDetail PnlWzemUsgDetail::StatShr
#define TagWzemUsgDetail PnlWzemUsgDetail::Tag

#define DpchAppWzemUsgDetailData PnlWzemUsgDetail::DpchAppData
#define DpchAppWzemUsgDetailDo PnlWzemUsgDetail::DpchAppDo
#define DpchEngWzemUsgDetailData PnlWzemUsgDetail::DpchEngData

/**
	* PnlWzemUsgDetail
	*/
class PnlWzemUsgDetail : public JobWzem {

public:
	/**
		* VecVDo (full: VecVWzemUsgDetailDo)
		*/
	class VecVDo {
	...
	/**
	  * ContIac (full: ContIacWzemUsgDetail)
	  */
	...
	/**
	  * ContInf (full: ContInfWzemUsgDetail)
	  */
	...
	/**
		* StatApp (full: StatAppWzemUsgDetail)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrWzemUsgDetail)
		*/
	...
	/**
		* DpchAppData (full: DpchAppWzemUsgDetailData)
		*/
	...
	/**
		* DpchAppDo (full: DpchAppWzemUsgDetailDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngWzemUsgDetailData)
		*/
...
public:
	PnlWzemUsgDetail(XchgWzem* xchg, DbsWzem* dbswzem, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWzemVLocale);
	~PnlWzemUsgDetail();
...
public:
	...
	void refreshRecUsg(DbsWzem* dbswzem, std::set<Sbecore::uint>& moditems);
