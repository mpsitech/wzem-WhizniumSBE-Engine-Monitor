...
void PnlWzemUsgHeadbar::StgInf::writeJSON(
...
void PnlWzemUsgHeadbar::Tag::writeJSON(
			const uint ixWzemVLocale
			, Json::Value& sup
			, string difftag
		) {
...
void PnlWzemUsgHeadbar::DpchEngData::writeJSON(
			const uint ixWzemVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWzemUsgHeadbarData"] = Json::Value(Json::objectValue);
