...
void QryWzemUsgMNUser::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint firstcol
...
void QryWzemUsgMNUser::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
bool QryWzemUsgMNUser::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacQryWzemUsgMNUser"];}();
...
void QryWzemUsgMNUser::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
