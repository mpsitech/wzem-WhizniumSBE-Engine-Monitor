/**
	* \file PnlWzemUsgMNUser_blks.cpp
	* job handler for job PnlWzemUsgMNUser (implementation of blocks)
...
/******************************************************************************
 class PnlWzemUsgMNUser::VecVDo
 ******************************************************************************/

uint PnlWzemUsgMNUser::VecVDo::getIx(
			const string& sref
		) {
...
string PnlWzemUsgMNUser::VecVDo::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class PnlWzemUsgMNUser::ContInf
 ******************************************************************************/

PnlWzemUsgMNUser::ContInf::ContInf(
...
void PnlWzemUsgMNUser::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWzemUsgMNUser";
...
void PnlWzemUsgMNUser::ContInf::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	else itemtag = "ContitemInfWzemUsgMNUser";
...
set<uint> PnlWzemUsgMNUser::ContInf::comm(
			const ContInf* comp
		) {
	set<uint> items;
...
set<uint> PnlWzemUsgMNUser::ContInf::diff(
			const ContInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWzemUsgMNUser::StatApp
 ******************************************************************************/

void PnlWzemUsgMNUser::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint ixWzemVExpstate
		) {
	if (difftag.length() == 0) difftag = "StatAppWzemUsgMNUser";
...
void PnlWzemUsgMNUser::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint ixWzemVExpstate
	...
	else itemtag = "StatitemAppWzemUsgMNUser";
...
/******************************************************************************
 class PnlWzemUsgMNUser::StatShr
 ******************************************************************************/

PnlWzemUsgMNUser::StatShr::StatShr(
...
void PnlWzemUsgMNUser::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWzemUsgMNUser";
...
void PnlWzemUsgMNUser::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrWzemUsgMNUser";
...
set<uint> PnlWzemUsgMNUser::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> PnlWzemUsgMNUser::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWzemUsgMNUser::StgIac
 ******************************************************************************/

PnlWzemUsgMNUser::StgIac::StgIac(
...
bool PnlWzemUsgMNUser::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacWzemUsgMNUser"];}();
...
bool PnlWzemUsgMNUser::StgIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacWzemUsgMNUser");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacWzemUsgMNUser";
...
void PnlWzemUsgMNUser::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StgIacWzemUsgMNUser";
...
void PnlWzemUsgMNUser::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacWzemUsgMNUser";
...
set<uint> PnlWzemUsgMNUser::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> PnlWzemUsgMNUser::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWzemUsgMNUser::Tag
 ******************************************************************************/

void PnlWzemUsgMNUser::Tag::writeJSON(
			const uint ixWzemVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWzemUsgMNUser";
...
void PnlWzemUsgMNUser::Tag::writeXML(
			const uint ixWzemVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWzemUsgMNUser";
...
/******************************************************************************
 class PnlWzemUsgMNUser::DpchAppData
 ******************************************************************************/

PnlWzemUsgMNUser::DpchAppData::DpchAppData() :
			DpchAppWzem(VecWzemVDpch::DPCHAPPWZEMUSGMNUSERDATA)
		{
};

string PnlWzemUsgMNUser::DpchAppData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWzemUsgMNUser::DpchAppData::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWzemUsgMNUserData"];}();
	...
	if (basefound) {
		...
		stgiac = StgIac();
		stgiacqry = QryWzemUsgMNUser::StgIac();
	};
};

void PnlWzemUsgMNUser::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWzemUsgMNUserData");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWzemUsgMNUser::DpchAppDo
 ******************************************************************************/

PnlWzemUsgMNUser::DpchAppDo::DpchAppDo() :
			DpchAppWzem(VecWzemVDpch::DPCHAPPWZEMUSGMNUSERDO)
		{
	ixVDo = 0;
};

string PnlWzemUsgMNUser::DpchAppDo::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWzemUsgMNUser::DpchAppDo::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWzemUsgMNUserDo"];}();
...
void PnlWzemUsgMNUser::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWzemUsgMNUserDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWzemUsgMNUser::DpchEngData
 ******************************************************************************/

PnlWzemUsgMNUser::DpchEngData::DpchEngData(
			const ubigint jref
			, ContInf* continf
			, Feed* feedFCsiQst
			, StatShr* statshr
			...
			DpchEngWzem(VecWzemVDpch::DPCHENGWZEMUSGMNUSERDATA, jref)
		{
...
string PnlWzemUsgMNUser::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWzemUsgMNUser::DpchEngData::merge(
			DpchEngWzem* dpcheng
		) {
...
void PnlWzemUsgMNUser::DpchEngData::writeJSON(
			const uint ixWzemVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWzemUsgMNUserData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryWzemUsgMNUser::StatApp::writeJSON(me);
	if (has(STATSHRQRY)) statshrqry.writeJSON(me);
	if (has(STGIACQRY)) stgiacqry.writeJSON(me);
};

void PnlWzemUsgMNUser::DpchEngData::writeXML(
			const uint ixWzemVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWzemUsgMNUserData");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wzem");
		...
		if (has(STATAPPQRY)) QryWzemUsgMNUser::StatApp::writeXML(wr);
