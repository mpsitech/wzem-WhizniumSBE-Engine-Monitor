...
void PnlWzemNdeRec::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
void PnlWzemNdeRec::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
...
void PnlWzemNdeRec::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
void PnlWzemNdeRec::Tag::writeJSON(
...
void PnlWzemNdeRec::DpchAppDo::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWzemNdeRecDo"];}();
...
void PnlWzemNdeRec::DpchEngData::writeJSON(
			const uint ixWzemVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWzemNdeRecData"] = Json::Value(Json::objectValue);
