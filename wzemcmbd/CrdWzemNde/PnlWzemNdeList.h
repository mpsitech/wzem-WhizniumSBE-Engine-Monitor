/**
	...
	* job handler for job PnlWzemNdeList (declarations)
...
/**
	* PnlWzemNdeList
	*/
class PnlWzemNdeList : public JobWzem {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, Sbecore::Xmlio::Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWzemQNdeList* rst = NULL, QryWzemNdeList::StatShr* statshrqry = NULL, QryWzemNdeList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWzemNdeList(XchgWzem* xchg, DbsWzem* dbswzem, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWzemVLocale);
	~PnlWzemNdeList();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWzem* dbswzem, QryWzemNdeList::StgIac* _stgiacqry, DpchEngWzem** dpcheng);
