/**
	* \file QryWzemNdeList_blks.cpp
	* job handler for job QryWzemNdeList (implementation of blocks)
...
/******************************************************************************
 class QryWzemNdeList::VecVOrd
 ******************************************************************************/

uint QryWzemNdeList::VecVOrd::getIx(
			const string& sref
		) {
...
void QryWzemNdeList::VecVOrd::fillFeed(
			Feed& feed
		) {
	feed.clear();
...
/******************************************************************************
 class QryWzemNdeList::StatApp
 ******************************************************************************/

void QryWzemNdeList::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint firstcol
	...
	if (difftag.length() == 0) difftag = "StatAppQryWzemNdeList";
...
void QryWzemNdeList::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint firstcol
	...
	else itemtag = "StatitemAppQryWzemNdeList";
...
/******************************************************************************
 class QryWzemNdeList::StatShr
 ******************************************************************************/

QryWzemNdeList::StatShr::StatShr(
			const uint ntot
...
void QryWzemNdeList::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrQryWzemNdeList";
...
void QryWzemNdeList::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrQryWzemNdeList";
...
set<uint> QryWzemNdeList::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryWzemNdeList::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryWzemNdeList::StgIac
 ******************************************************************************/

QryWzemNdeList::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) :
...
bool QryWzemNdeList::StgIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryWzemNdeList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryWzemNdeList";
...
void QryWzemNdeList::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StgIacQryWzemNdeList";
...
void QryWzemNdeList::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryWzemNdeList";
...
set<uint> QryWzemNdeList::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryWzemNdeList::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
