/**
	* \file PnlWzemCalList_blks.cpp
	* job handler for job PnlWzemCalList (implementation of blocks)
...
/******************************************************************************
 class PnlWzemCalList::VecVDo
 ******************************************************************************/

uint PnlWzemCalList::VecVDo::getIx(
			const string& sref
		) {
...
string PnlWzemCalList::VecVDo::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class PnlWzemCalList::ContIac
 ******************************************************************************/

PnlWzemCalList::ContIac::ContIac(
			const uint numFTos
		) :
			Block()
		{
...
bool PnlWzemCalList::ContIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["ContIacWzemCalList"];}();
...
bool PnlWzemCalList::ContIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContIacWzemCalList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "ContitemIacWzemCalList";
...
void PnlWzemCalList::ContIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContIacWzemCalList";
...
void PnlWzemCalList::ContIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	else itemtag = "ContitemIacWzemCalList";
...
set<uint> PnlWzemCalList::ContIac::comm(
			const ContIac* comp
		) {
	set<uint> items;
...
set<uint> PnlWzemCalList::ContIac::diff(
			const ContIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWzemCalList::ContInf
 ******************************************************************************/

PnlWzemCalList::ContInf::ContInf(
			const string& TxtFor
			, const string& TxtPre
...
void PnlWzemCalList::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWzemCalList";
...
void PnlWzemCalList::ContInf::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Ci";
	else itemtag = "ContitemInfWzemCalList";
...
set<uint> PnlWzemCalList::ContInf::comm(
			const ContInf* comp
		) {
	set<uint> items;
...
set<uint> PnlWzemCalList::ContInf::diff(
			const ContInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWzemCalList::StatShr
 ******************************************************************************/

PnlWzemCalList::StatShr::StatShr(
...
void PnlWzemCalList::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWzemCalList";
...
void PnlWzemCalList::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	else itemtag = "StatitemShrWzemCalList";
...
set<uint> PnlWzemCalList::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> PnlWzemCalList::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWzemCalList::StgIac
 ******************************************************************************/

PnlWzemCalList::StgIac::StgIac(
	...
	mask = {TCOJOBWIDTH, TCOCALWIDTH, TCOSTAWIDTH, TCOSTOWIDTH};
};

bool PnlWzemCalList::StgIac::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacWzemCalList"];}();
...
bool PnlWzemCalList::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacWzemCalList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacWzemCalList";
...
void PnlWzemCalList::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StgIacWzemCalList";
...
void PnlWzemCalList::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacWzemCalList";
...
set<uint> PnlWzemCalList::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> PnlWzemCalList::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
	...
	diffitems = {TCOJOBWIDTH, TCOCALWIDTH, TCOSTAWIDTH, TCOSTOWIDTH};
	for (auto it = commitems.begin(); it != commitems.end(); it++) diffitems.erase(*it);
...
/******************************************************************************
 class PnlWzemCalList::Tag
 ******************************************************************************/

void PnlWzemCalList::Tag::writeJSON(
			const uint ixWzemVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWzemCalList";
...
void PnlWzemCalList::Tag::writeXML(
			const uint ixWzemVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWzemCalList";
...
/******************************************************************************
 class PnlWzemCalList::DpchAppData
 ******************************************************************************/

PnlWzemCalList::DpchAppData::DpchAppData() :
			DpchAppWzem(VecWzemVDpch::DPCHAPPWZEMCALLISTDATA)
		{
};

string PnlWzemCalList::DpchAppData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWzemCalList::DpchAppData::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWzemCalListData"];}();
	...
	if (basefound) {
		...
		contiac = ContIac();
		stgiac = StgIac();
		stgiacqry = QryWzemCalList::StgIac();
	};
};

void PnlWzemCalList::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWzemCalListData");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWzemCalList::DpchAppDo
 ******************************************************************************/

PnlWzemCalList::DpchAppDo::DpchAppDo() :
			DpchAppWzem(VecWzemVDpch::DPCHAPPWZEMCALLISTDO)
		{
	ixVDo = 0;
};

string PnlWzemCalList::DpchAppDo::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWzemCalList::DpchAppDo::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWzemCalListDo"];}();
...
void PnlWzemCalList::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWzemCalListDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWzemCalList::DpchEngData
 ******************************************************************************/

PnlWzemCalList::DpchEngData::DpchEngData(
			const ubigint jref
			, ContIac* contiac
			, ContInf* continf
			, Feed* feedFCsiQst
			...
			DpchEngWzem(VecWzemVDpch::DPCHENGWZEMCALLISTDATA, jref)
		{
...
string PnlWzemCalList::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWzemCalList::DpchEngData::merge(
			DpchEngWzem* dpcheng
		) {
...
void PnlWzemCalList::DpchEngData::writeJSON(
			const uint ixWzemVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWzemCalListData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryWzemCalList::StatApp::writeJSON(me);
	if (has(STATSHRQRY)) statshrqry.writeJSON(me);
	if (has(STGIACQRY)) stgiacqry.writeJSON(me);
};

void PnlWzemCalList::DpchEngData::writeXML(
			const uint ixWzemVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWzemCalListData");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wzem");
		...
		if (has(STATAPPQRY)) QryWzemCalList::StatApp::writeXML(wr);
