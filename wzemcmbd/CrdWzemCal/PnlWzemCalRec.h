/**
	...
	* job handler for job PnlWzemCalRec (declarations)
...
/**
	* PnlWzemCalRec
	*/
class PnlWzemCalRec : public JobWzem {
...
public:
	PnlWzemCalRec(XchgWzem* xchg, DbsWzem* dbswzem, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWzemVLocale);
	~PnlWzemCalRec();
