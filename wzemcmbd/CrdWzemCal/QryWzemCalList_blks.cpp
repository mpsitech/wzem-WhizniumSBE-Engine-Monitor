...
void QryWzemCalList::VecVOrd::fillFeed(
			Feed& feed
		) {
	feed.clear();
...
void QryWzemCalList::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint firstcol
	...
	if (difftag.length() == 0) difftag = "StatAppQryWzemCalList";
...
void QryWzemCalList::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint firstcol
	...
	else itemtag = "StatitemAppQryWzemCalList";
...
void QryWzemCalList::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrQryWzemCalList";
...
void QryWzemCalList::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrQryWzemCalList";
...
void QryWzemCalList::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
