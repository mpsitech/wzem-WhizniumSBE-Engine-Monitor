...
#define ContInfWzemPst CrdWzemPst::ContInf
#define StatAppWzemPst CrdWzemPst::StatApp
#define StatShrWzemPst CrdWzemPst::StatShr
#define TagWzemPst CrdWzemPst::Tag

#define DpchAppWzemPstDo CrdWzemPst::DpchAppDo
#define DpchEngWzemPstData CrdWzemPst::DpchEngData

/**
	* CrdWzemPst
	*/
class CrdWzemPst : public JobWzem {

public:
	/**
		* VecVDo (full: VecVWzemPstDo)
		*/
	class VecVDo {
	...
	/**
		* DpchAppDo (full: DpchAppWzemPstDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngWzemPstData)
		*/
...
public:
	CrdWzemPst(XchgWzem* xchg, DbsWzem* dbswzem, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWzemVLocale, const Sbecore::ubigint ref = 0, const Sbecore::uint ixWzemVPreset = VecWzemVPreset::VOID, const Sbecore::ubigint preUref = 0);
	~CrdWzemPst();
