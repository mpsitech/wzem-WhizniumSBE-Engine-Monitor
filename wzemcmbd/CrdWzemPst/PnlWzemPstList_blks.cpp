/**
	* \file PnlWzemPstList_blks.cpp
	* job handler for job PnlWzemPstList (implementation of blocks)
...
/******************************************************************************
 class PnlWzemPstList::VecVDo
 ******************************************************************************/

uint PnlWzemPstList::VecVDo::getIx(
			const string& sref
		) {
...
string PnlWzemPstList::VecVDo::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class PnlWzemPstList::ContIac
 ******************************************************************************/

PnlWzemPstList::ContIac::ContIac(
			const uint numFTos
		) :
			Block()
		{
...
bool PnlWzemPstList::ContIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["ContIacWzemPstList"];}();
...
bool PnlWzemPstList::ContIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContIacWzemPstList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "ContitemIacWzemPstList";
...
void PnlWzemPstList::ContIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContIacWzemPstList";
...
void PnlWzemPstList::ContIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	else itemtag = "ContitemIacWzemPstList";
...
set<uint> PnlWzemPstList::ContIac::comm(
			const ContIac* comp
		) {
	set<uint> items;
...
set<uint> PnlWzemPstList::ContIac::diff(
			const ContIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWzemPstList::ContInf
 ******************************************************************************/

PnlWzemPstList::ContInf::ContInf(
			const string& TxtFor
			, const string& TxtPre
...
void PnlWzemPstList::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWzemPstList";
...
void PnlWzemPstList::ContInf::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Ci";
	else itemtag = "ContitemInfWzemPstList";
...
set<uint> PnlWzemPstList::ContInf::comm(
			const ContInf* comp
		) {
	set<uint> items;
...
set<uint> PnlWzemPstList::ContInf::diff(
			const ContInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWzemPstList::StatShr
 ******************************************************************************/

PnlWzemPstList::StatShr::StatShr(
...
void PnlWzemPstList::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWzemPstList";
...
void PnlWzemPstList::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	else itemtag = "StatitemShrWzemPstList";
...
set<uint> PnlWzemPstList::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> PnlWzemPstList::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWzemPstList::StgIac
 ******************************************************************************/

PnlWzemPstList::StgIac::StgIac(
	...
	mask = {TCOJOBWIDTH, TCOPSTWIDTH, TCOSTAWIDTH, TCOSTOWIDTH};
};

bool PnlWzemPstList::StgIac::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacWzemPstList"];}();
...
bool PnlWzemPstList::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacWzemPstList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacWzemPstList";
...
void PnlWzemPstList::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StgIacWzemPstList";
...
void PnlWzemPstList::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacWzemPstList";
...
set<uint> PnlWzemPstList::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> PnlWzemPstList::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
	...
	diffitems = {TCOJOBWIDTH, TCOPSTWIDTH, TCOSTAWIDTH, TCOSTOWIDTH};
	for (auto it = commitems.begin(); it != commitems.end(); it++) diffitems.erase(*it);
...
/******************************************************************************
 class PnlWzemPstList::Tag
 ******************************************************************************/

void PnlWzemPstList::Tag::writeJSON(
			const uint ixWzemVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWzemPstList";
...
void PnlWzemPstList::Tag::writeXML(
			const uint ixWzemVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
...
/******************************************************************************
 class PnlWzemPstList::DpchAppData
 ******************************************************************************/

PnlWzemPstList::DpchAppData::DpchAppData() :
			DpchAppWzem(VecWzemVDpch::DPCHAPPWZEMPSTLISTDATA)
		{
};

string PnlWzemPstList::DpchAppData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWzemPstList::DpchAppData::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWzemPstListData"];}();
...
void PnlWzemPstList::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWzemPstListData");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWzemPstList::DpchAppDo
 ******************************************************************************/

PnlWzemPstList::DpchAppDo::DpchAppDo() :
			DpchAppWzem(VecWzemVDpch::DPCHAPPWZEMPSTLISTDO)
		{
	ixVDo = 0;
};

string PnlWzemPstList::DpchAppDo::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWzemPstList::DpchAppDo::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWzemPstListDo"];}();
...
void PnlWzemPstList::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWzemPstListDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWzemPstList::DpchEngData
 ******************************************************************************/

PnlWzemPstList::DpchEngData::DpchEngData(
			const ubigint jref
			, ContIac* contiac
			, ContInf* continf
			, Feed* feedFCsiQst
			...
			DpchEngWzem(VecWzemVDpch::DPCHENGWZEMPSTLISTDATA, jref)
		{
...
string PnlWzemPstList::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWzemPstList::DpchEngData::merge(
			DpchEngWzem* dpcheng
		) {
...
void PnlWzemPstList::DpchEngData::writeJSON(
			const uint ixWzemVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWzemPstListData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryWzemPstList::StatApp::writeJSON(me);
	if (has(STATSHRQRY)) statshrqry.writeJSON(me);
	if (has(STGIACQRY)) stgiacqry.writeJSON(me);
};

void PnlWzemPstList::DpchEngData::writeXML(
			const uint ixWzemVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWzemPstListData");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wzem");
		...
		if (has(STATAPPQRY)) QryWzemPstList::StatApp::writeXML(wr);
