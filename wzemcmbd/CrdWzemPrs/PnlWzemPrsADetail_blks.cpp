/**
	* \file PnlWzemPrsADetail_blks.cpp
	* job handler for job PnlWzemPrsADetail (implementation of blocks)
...
/******************************************************************************
 class PnlWzemPrsADetail::VecVDo
 ******************************************************************************/

uint PnlWzemPrsADetail::VecVDo::getIx(
			const string& sref
		) {
...
string PnlWzemPrsADetail::VecVDo::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class PnlWzemPrsADetail::ContInf
 ******************************************************************************/

PnlWzemPrsADetail::ContInf::ContInf(
...
void PnlWzemPrsADetail::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWzemPrsADetail";
...
void PnlWzemPrsADetail::ContInf::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	else itemtag = "ContitemInfWzemPrsADetail";
...
set<uint> PnlWzemPrsADetail::ContInf::comm(
			const ContInf* comp
		) {
	set<uint> items;
...
set<uint> PnlWzemPrsADetail::ContInf::diff(
			const ContInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWzemPrsADetail::StatApp
 ******************************************************************************/

void PnlWzemPrsADetail::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint ixWzemVExpstate
		) {
	if (difftag.length() == 0) difftag = "StatAppWzemPrsADetail";
...
void PnlWzemPrsADetail::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint ixWzemVExpstate
	...
	else itemtag = "StatitemAppWzemPrsADetail";
...
/******************************************************************************
 class PnlWzemPrsADetail::StatShr
 ******************************************************************************/

PnlWzemPrsADetail::StatShr::StatShr(
...
void PnlWzemPrsADetail::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWzemPrsADetail";
...
void PnlWzemPrsADetail::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrWzemPrsADetail";
...
set<uint> PnlWzemPrsADetail::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> PnlWzemPrsADetail::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWzemPrsADetail::StgIac
 ******************************************************************************/

PnlWzemPrsADetail::StgIac::StgIac(
...
bool PnlWzemPrsADetail::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacWzemPrsADetail"];}();
...
bool PnlWzemPrsADetail::StgIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacWzemPrsADetail");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacWzemPrsADetail";
...
void PnlWzemPrsADetail::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StgIacWzemPrsADetail";
...
void PnlWzemPrsADetail::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacWzemPrsADetail";
...
set<uint> PnlWzemPrsADetail::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> PnlWzemPrsADetail::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWzemPrsADetail::Tag
 ******************************************************************************/

void PnlWzemPrsADetail::Tag::writeJSON(
			const uint ixWzemVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWzemPrsADetail";
...
void PnlWzemPrsADetail::Tag::writeXML(
			const uint ixWzemVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWzemPrsADetail";
...
/******************************************************************************
 class PnlWzemPrsADetail::DpchAppData
 ******************************************************************************/

PnlWzemPrsADetail::DpchAppData::DpchAppData() :
			DpchAppWzem(VecWzemVDpch::DPCHAPPWZEMPRSADETAILDATA)
		{
};

string PnlWzemPrsADetail::DpchAppData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWzemPrsADetail::DpchAppData::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWzemPrsADetailData"];}();
	...
	if (basefound) {
		...
		stgiac = StgIac();
		stgiacqry = QryWzemPrsADetail::StgIac();
	};
};

void PnlWzemPrsADetail::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWzemPrsADetailData");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWzemPrsADetail::DpchAppDo
 ******************************************************************************/

PnlWzemPrsADetail::DpchAppDo::DpchAppDo() :
			DpchAppWzem(VecWzemVDpch::DPCHAPPWZEMPRSADETAILDO)
		{
	ixVDo = 0;
};

string PnlWzemPrsADetail::DpchAppDo::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWzemPrsADetail::DpchAppDo::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWzemPrsADetailDo"];}();
...
void PnlWzemPrsADetail::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWzemPrsADetailDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWzemPrsADetail::DpchEngData
 ******************************************************************************/

PnlWzemPrsADetail::DpchEngData::DpchEngData(
			const ubigint jref
			, ContInf* continf
			, Feed* feedFCsiQst
			, StatShr* statshr
			...
			DpchEngWzem(VecWzemVDpch::DPCHENGWZEMPRSADETAILDATA, jref)
		{
...
string PnlWzemPrsADetail::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWzemPrsADetail::DpchEngData::merge(
			DpchEngWzem* dpcheng
		) {
...
void PnlWzemPrsADetail::DpchEngData::writeJSON(
			const uint ixWzemVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWzemPrsADetailData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryWzemPrsADetail::StatApp::writeJSON(me);
	if (has(STATSHRQRY)) statshrqry.writeJSON(me);
	if (has(STGIACQRY)) stgiacqry.writeJSON(me);
};

void PnlWzemPrsADetail::DpchEngData::writeXML(
			const uint ixWzemVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWzemPrsADetailData");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wzem");
		...
		if (has(STATAPPQRY)) QryWzemPrsADetail::StatApp::writeXML(wr);
