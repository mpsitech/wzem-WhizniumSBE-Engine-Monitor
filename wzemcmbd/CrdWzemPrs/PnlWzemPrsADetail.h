...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWzemQPrsADetail* rst = NULL, QryWzemPrsADetail::StatShr* statshrqry = NULL, QryWzemPrsADetail::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
