/**
	* \file QryWzemOpxList.h
	* job handler for job QryWzemOpxList (declarations)
...
#ifndef QRYWZEMOPXLIST_H
#define QRYWZEMOPXLIST_H

// IP include.spec --- INSERT

// IP include.cust --- INSERT

#define VecVQryWzemOpxListOrd QryWzemOpxList::VecVOrd

#define StatAppQryWzemOpxList QryWzemOpxList::StatApp
#define StatShrQryWzemOpxList QryWzemOpxList::StatShr
#define StgIacQryWzemOpxList QryWzemOpxList::StgIac

/**
	* QryWzemOpxList
	*/
class QryWzemOpxList : public JobWzem {

public:
	/**
		* VecVOrd (full: VecVQryWzemOpxListOrd)
		*/
	class VecVOrd {
	...
	/**
		* StatApp (full: StatAppQryWzemOpxList)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrQryWzemOpxList)
		*/
	...
	/**
		* StgIac (full: StgIacQryWzemOpxList)
		*/
...
public:
	QryWzemOpxList(XchgWzem* xchg, DbsWzem* dbswzem, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWzemVLocale);
	~QryWzemOpxList();
...
public:
	...
	WzemQOpxList* getRecByJnum(const Sbecore::uint jnum);
