/**
	* \file PnlWzemOpxRec.h
	* job handler for job PnlWzemOpxRec (declarations)
...
#ifndef PNLWZEMOPXREC_H
#define PNLWZEMOPXREC_H
...
#define VecVWzemOpxRecDo PnlWzemOpxRec::VecVDo

#define ContInfWzemOpxRec PnlWzemOpxRec::ContInf
#define StatAppWzemOpxRec PnlWzemOpxRec::StatApp
#define StatShrWzemOpxRec PnlWzemOpxRec::StatShr
#define TagWzemOpxRec PnlWzemOpxRec::Tag

#define DpchAppWzemOpxRecDo PnlWzemOpxRec::DpchAppDo
#define DpchEngWzemOpxRecData PnlWzemOpxRec::DpchEngData

/**
	* PnlWzemOpxRec
	*/
class PnlWzemOpxRec : public JobWzem {

public:
	/**
		* VecVDo (full: VecVWzemOpxRecDo)
		*/
	class VecVDo {
	...
	/**
	  * ContInf (full: ContInfWzemOpxRec)
	  */
	...
	/**
		* StatApp (full: StatAppWzemOpxRec)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrWzemOpxRec)
		*/
	...
	/**
		* DpchAppDo (full: DpchAppWzemOpxRecDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngWzemOpxRecData)
		*/
...
public:
	PnlWzemOpxRec(XchgWzem* xchg, DbsWzem* dbswzem, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWzemVLocale);
	~PnlWzemOpxRec();
