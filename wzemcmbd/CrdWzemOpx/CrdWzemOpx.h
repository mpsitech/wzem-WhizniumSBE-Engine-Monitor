/**
	* \file CrdWzemOpx.h
	* job handler for job CrdWzemOpx (declarations)
...
/**
	* CrdWzemOpx
	*/
class CrdWzemOpx : public JobWzem {
...
public:
	CrdWzemOpx(XchgWzem* xchg, DbsWzem* dbswzem, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWzemVLocale, const Sbecore::ubigint ref = 0, const Sbecore::uint ixWzemVPreset = VecWzemVPreset::VOID, const Sbecore::ubigint preUref = 0);
	~CrdWzemOpx();
...
public:
	...
	PnlWzemOpxList* pnllist;
	PnlWzemOpxHeadbar* pnlheadbar;
	PnlWzemOpxRec* pnlrec;
