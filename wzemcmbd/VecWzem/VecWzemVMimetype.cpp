/**
	* \file VecWzemVMimetype.cpp
	* vector VecWzemVMimetype (implementation)
...
/******************************************************************************
 namespace VecWzemVMimetype
 ******************************************************************************/

uint VecWzemVMimetype::getIx(
			const string& sref
		) {
...
string VecWzemVMimetype::getSref(
			const uint ix
		) {
...
string VecWzemVMimetype::getTitle(
			const uint ix
		) {
