...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWzemQPrd1NEvent* rst = NULL, QryWzemPrd1NEvent::StatShr* statshrqry = NULL, QryWzemPrd1NEvent::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
