...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWzemQPrd1NNode* rst = NULL, QryWzemPrd1NNode::StatShr* statshrqry = NULL, QryWzemPrd1NNode::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
