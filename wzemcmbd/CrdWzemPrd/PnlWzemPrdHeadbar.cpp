/**
	...
	* job handler for job PnlWzemPrdHeadbar (implementation)
...
#include "PnlWzemPrdHeadbar_blks.cpp"
...
/******************************************************************************
 class PnlWzemPrdHeadbar
 ******************************************************************************/

PnlWzemPrdHeadbar::PnlWzemPrdHeadbar(
			XchgWzem* xchg
			, DbsWzem* dbswzem
			, const ubigint jrefSup
			, const uint ixWzemVLocale
		) :
			JobWzem(xchg, VecWzemVJob::PNLWZEMPRDHEADBAR, jrefSup, ixWzemVLocale)
		{
...
DpchEngWzem* PnlWzemPrdHeadbar::getNewDpchEng(
			set<uint> items
		) {
...
void PnlWzemPrdHeadbar::refresh(
			DbsWzem* dbswzem
			, set<uint>& moditems
			, const bool unmute
		) {
...
void PnlWzemPrdHeadbar::handleRequest(
			DbsWzem* dbswzem
			, ReqWzem* req
		) {
...
void PnlWzemPrdHeadbar::handleDpchAppWzemInit(
			DbsWzem* dbswzem
