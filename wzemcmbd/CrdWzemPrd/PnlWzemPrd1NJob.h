...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWzemQPrd1NJob* rst = NULL, QryWzemPrd1NJob::StatShr* statshrqry = NULL, QryWzemPrd1NJob::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
