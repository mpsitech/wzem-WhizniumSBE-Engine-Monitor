#!/bin/bash
# file checkout.sh
# checkout script for Wzem combined daemon, release wzemcmbd_zedboard(jack (x86ubt) cross-compilation)
...
export set LIBROOT=/home/mpsitech/emb/zedboard/avnet-digilent-zedboard-2017.2/build/tmp/sysroots/plnx_arm/home/root/lib
export set BINROOT=/home/mpsitech/emb/zedboard/avnet-digilent-zedboard-2017.2/build/tmp/sysroots/plnx_arm/home/root/bin
