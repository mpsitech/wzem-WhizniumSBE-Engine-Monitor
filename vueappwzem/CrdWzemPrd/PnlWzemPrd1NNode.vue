...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWzemPrd1NNode.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWzemPrd1NNodeData": {
						"scrJref": this.scrJref,
						"StgIacQryWzemPrd1NNode": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWzemPrd1NNode"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWzemPrd1NNodeData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWzemPrd1NNodeData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWzemPrd1NNode) this.continf = dpcheng.ContInfWzemPrd1NNode;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWzemPrd1NNode) this.statapp = dpcheng.StatAppWzemPrd1NNode;
				if (dpcheng.StatShrWzemPrd1NNode) this.statshr = dpcheng.StatShrWzemPrd1NNode;
				if (dpcheng.StgIacWzemPrd1NNode) this.stgiac = dpcheng.StgIacWzemPrd1NNode;
				if (dpcheng.TagWzemPrd1NNode) {
					Wzem.unescapeBlock(dpcheng.TagWzemPrd1NNode);
					this.tag = dpcheng.TagWzemPrd1NNode;
				}
				if (dpcheng.ListWzemQPrd1NNode) this.rst = dpcheng.ListWzemQPrd1NNode;
				if (dpcheng.StatAppQryWzemPrd1NNode) this.statappqry = dpcheng.StatAppQryWzemPrd1NNode;
				if (dpcheng.StatShrQryWzemPrd1NNode) this.statshrqry = dpcheng.StatShrQryWzemPrd1NNode;
				if (dpcheng.StgIacQryWzemPrd1NNode) this.stgiacqry = dpcheng.StgIacQryWzemPrd1NNode;
				/*
			...
			handleDpchAppDataDoReply: function(srefIxWzemVDpch, dpcheng) {
				if (srefIxWzemVDpch == "DpchEngWzemPrd1NNodeData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWzemVDpch == "DpchEngWzemPrd1NNodeData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
