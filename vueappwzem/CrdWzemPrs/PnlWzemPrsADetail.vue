...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWzemPrsADetail.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWzemPrsADetailData": {
						"scrJref": this.scrJref,
						"StgIacQryWzemPrsADetail": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWzemPrsADetail"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWzemPrsADetailData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWzemPrsADetailData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWzemPrsADetail) this.continf = dpcheng.ContInfWzemPrsADetail;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWzemPrsADetail) this.statapp = dpcheng.StatAppWzemPrsADetail;
				if (dpcheng.StatShrWzemPrsADetail) this.statshr = dpcheng.StatShrWzemPrsADetail;
				if (dpcheng.StgIacWzemPrsADetail) this.stgiac = dpcheng.StgIacWzemPrsADetail;
				if (dpcheng.TagWzemPrsADetail) {
					Wzem.unescapeBlock(dpcheng.TagWzemPrsADetail);
					this.tag = dpcheng.TagWzemPrsADetail;
				}
				if (dpcheng.ListWzemQPrsADetail) this.rst = dpcheng.ListWzemQPrsADetail;
				if (dpcheng.StatAppQryWzemPrsADetail) this.statappqry = dpcheng.StatAppQryWzemPrsADetail;
				if (dpcheng.StatShrQryWzemPrsADetail) this.statshrqry = dpcheng.StatShrQryWzemPrsADetail;
				if (dpcheng.StgIacQryWzemPrsADetail) this.stgiacqry = dpcheng.StgIacQryWzemPrsADetail;
				/*
				...
				*/
				...
				if (dpcheng.ListWzemQPrsADetail) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWzemVDpch, dpcheng) {
				if (srefIxWzemVDpch == "DpchEngWzemPrsADetailData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWzemVDpch == "DpchEngWzemPrsADetailData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
