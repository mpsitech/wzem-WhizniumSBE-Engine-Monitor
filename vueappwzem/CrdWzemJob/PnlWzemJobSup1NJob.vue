...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWzemJobSup1NJob.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWzemJobSup1NJobData": {
						"scrJref": this.scrJref,
						"StgIacQryWzemJobSup1NJob": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWzemJobSup1NJob"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWzemJobSup1NJobData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWzemJobSup1NJobData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWzemJobSup1NJob) this.continf = dpcheng.ContInfWzemJobSup1NJob;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWzemJobSup1NJob) this.statapp = dpcheng.StatAppWzemJobSup1NJob;
				if (dpcheng.StatShrWzemJobSup1NJob) this.statshr = dpcheng.StatShrWzemJobSup1NJob;
				if (dpcheng.StgIacWzemJobSup1NJob) this.stgiac = dpcheng.StgIacWzemJobSup1NJob;
				if (dpcheng.TagWzemJobSup1NJob) {
					Wzem.unescapeBlock(dpcheng.TagWzemJobSup1NJob);
					this.tag = dpcheng.TagWzemJobSup1NJob;
				}
				if (dpcheng.ListWzemQJobSup1NJob) this.rst = dpcheng.ListWzemQJobSup1NJob;
				if (dpcheng.StatAppQryWzemJobSup1NJob) this.statappqry = dpcheng.StatAppQryWzemJobSup1NJob;
				if (dpcheng.StatShrQryWzemJobSup1NJob) this.statshrqry = dpcheng.StatShrQryWzemJobSup1NJob;
				if (dpcheng.StgIacQryWzemJobSup1NJob) this.stgiacqry = dpcheng.StgIacQryWzemJobSup1NJob;
				/*
				...
				*/
				...
				if (dpcheng.ListWzemQJobSup1NJob) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWzemVDpch, dpcheng) {
				if (srefIxWzemVDpch == "DpchEngWzemJobSup1NJobData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWzemVDpch == "DpchEngWzemJobSup1NJobData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
