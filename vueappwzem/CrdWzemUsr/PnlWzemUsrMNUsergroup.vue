...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWzemUsrMNUsergroup.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWzemUsrMNUsergroupData": {
						"scrJref": this.scrJref,
						"StgIacQryWzemUsrMNUsergroup": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWzemUsrMNUsergroup"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWzemUsrMNUsergroupData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWzemUsrMNUsergroupData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWzemUsrMNUsergroup) this.continf = dpcheng.ContInfWzemUsrMNUsergroup;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWzemUsrMNUsergroup) this.statapp = dpcheng.StatAppWzemUsrMNUsergroup;
				if (dpcheng.StatShrWzemUsrMNUsergroup) this.statshr = dpcheng.StatShrWzemUsrMNUsergroup;
				if (dpcheng.StgIacWzemUsrMNUsergroup) this.stgiac = dpcheng.StgIacWzemUsrMNUsergroup;
				if (dpcheng.TagWzemUsrMNUsergroup) {
					Wzem.unescapeBlock(dpcheng.TagWzemUsrMNUsergroup);
					this.tag = dpcheng.TagWzemUsrMNUsergroup;
				}
				if (dpcheng.ListWzemQUsrMNUsergroup) this.rst = dpcheng.ListWzemQUsrMNUsergroup;
				if (dpcheng.StatAppQryWzemUsrMNUsergroup) this.statappqry = dpcheng.StatAppQryWzemUsrMNUsergroup;
				if (dpcheng.StatShrQryWzemUsrMNUsergroup) this.statshrqry = dpcheng.StatShrQryWzemUsrMNUsergroup;
				if (dpcheng.StgIacQryWzemUsrMNUsergroup) this.stgiacqry = dpcheng.StgIacQryWzemUsrMNUsergroup;
				/*
				...
				*/
				...
				if (dpcheng.ListWzemQUsrMNUsergroup) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWzemVDpch, dpcheng) {
				if (srefIxWzemVDpch == "DpchEngWzemUsrMNUsergroupData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWzemVDpch == "DpchEngWzemUsrMNUsergroupData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
