...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWzemUsr1NSession.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWzemUsr1NSessionData": {
						"scrJref": this.scrJref,
						"StgIacQryWzemUsr1NSession": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWzemUsr1NSession"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWzemUsr1NSessionData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWzemUsr1NSessionData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWzemUsr1NSession) this.continf = dpcheng.ContInfWzemUsr1NSession;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWzemUsr1NSession) this.statapp = dpcheng.StatAppWzemUsr1NSession;
				if (dpcheng.StatShrWzemUsr1NSession) this.statshr = dpcheng.StatShrWzemUsr1NSession;
				if (dpcheng.StgIacWzemUsr1NSession) this.stgiac = dpcheng.StgIacWzemUsr1NSession;
				if (dpcheng.TagWzemUsr1NSession) {
					Wzem.unescapeBlock(dpcheng.TagWzemUsr1NSession);
					this.tag = dpcheng.TagWzemUsr1NSession;
				}
				if (dpcheng.ListWzemQUsr1NSession) this.rst = dpcheng.ListWzemQUsr1NSession;
				if (dpcheng.StatAppQryWzemUsr1NSession) this.statappqry = dpcheng.StatAppQryWzemUsr1NSession;
				if (dpcheng.StatShrQryWzemUsr1NSession) this.statshrqry = dpcheng.StatShrQryWzemUsr1NSession;
				if (dpcheng.StgIacQryWzemUsr1NSession) this.stgiacqry = dpcheng.StgIacQryWzemUsr1NSession;
				/*
				...
				*/
				...
				if (dpcheng.ListWzemQUsr1NSession) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWzemVDpch, dpcheng) {
				if (srefIxWzemVDpch == "DpchEngWzemUsr1NSessionData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWzemVDpch == "DpchEngWzemUsr1NSessionData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
